...
Brief Discription: This program test my matrix operation class on Complex Matricies
Limitations: None
...
int main(){
	matrix<complex<double> > a(2,2), b(2,2), c(2,2), d(4,4); // we can also declare matrices of type int, float, double etc.
	a.SetOutputStyle(Matrix);
	b.SetOutputStyle(Matrix);
	c.SetOutputStyle(Matrix);
	d.SetOutputStyle(Matrix);
	
	cout << "Enter complex matrix a: " << endl;
	cin >> a;
	cout << "a is: " << endl;
	cout << a << endl;
	cout << "Enter complex matrix b: " << endl;
	cin >> b;	
	cout << "b is: " << endl;
	cout << b << endl;
	...
	cout << "A is hermitian " << MOs::IsHermitian(a) << endl;
	...
	c = MOs::Dagger(a);
	cout << endl << "Result of Dagger(a):" << endl;
	cout << c << endl;
