...
int main (int argc, char const *argv[]){
	...
	double Delta2 = Delta;
	double tolerance=0.00000000000000001, fidelity=0.999999, base_a=1.7, epsilon=0.000005, tgate=1, dt;  //search params
	double rab = M_PI;
...
//	system("mkdir hello");
		...
		OptimizeEvolution baselinesys(dim, num_controls, rwa_num_time, rwa_dt, "RWAcompare_rob");
...
//		
		...
		{	sys[s] = new OptimizeEvolution(dim, num_controls, rwa_num_time/mult, rwa_dt*mult, "altevol");
