/*
Name: TestRombergRK4.cpp
Author: Jay Gambetta

Dependences: OrdinaryDiffEqs.hpp  
Brief Discription: Demonstrates the use of my ODE solver using the RK4 method with the Roberg-Richardson extrapolation and a constant stepper
...
{	
	...
	//Files 
	ofstream data_out;
	string filename = "TestRombergRK4.dat";
