...
//	
	...
	for(size_t itime=0; itime<20; itime++, rwa_num_time+=20*theControls_[0]->nsubpixels_)
	{	
...
//			{
		...
		//	if(tries==62) iscrap=true;
			...
			theControls_[0]->writefile("initctrl.dat");
			theControls_[1]->writefile("initctrl1.dat");
			theControls_[2]->writefile("initctrl2.dat");
			theControls_[3]->writefile("initctrl3.dat");				
