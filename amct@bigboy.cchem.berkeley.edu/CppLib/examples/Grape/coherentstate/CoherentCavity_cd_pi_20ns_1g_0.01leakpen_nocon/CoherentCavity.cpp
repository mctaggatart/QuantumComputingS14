...
int main (int argc, char const *argv[]){
	...
	cout << dim << endl;
	SweepOptimization sys(dim, num_controls, num_time, dt, "CoherentCavity_cd_pi_20ns_1g_0.01leakpen_nocon");
	...
	Hdrift =  MOs::TensorProduct(HdriftCav, IdentQ) + MOs::TensorProduct(IdentCav, HdriftQ) + 1.0*Hcouple;
...
//	U_desired =  MOs::TensorProduct(IdentCav, IdentQ);
	...
	u0.setparams(&AnalyticControl::RandomControl, 0, 0.0,  0, NULL, NULL);
	...
	u1.setparams(&AnalyticControl::RandomControl, -0.0, 0.0,  0, NULL, NULL);
