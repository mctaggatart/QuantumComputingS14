...
int main (int argc, char const *argv[]){
	...
	cout << dim << endl;
	SweepOptimization sys(dim, num_controls, num_time, dt, "CoherentCavity_cd_pi_20ns_1g_2D_0.01leakpen");
	strcat(cmd, sys.filename_);
	system(cmd);
	sys.SetNumericalParameters(fidelity=0.9909999999, base_a, epsilon, tolerance, max_iter);
