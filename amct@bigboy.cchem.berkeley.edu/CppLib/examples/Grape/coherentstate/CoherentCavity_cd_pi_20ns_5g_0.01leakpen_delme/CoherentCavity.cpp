...
int main (int argc, char const *argv[]){
	...
	cout << dim << endl;
	SweepOptimization sys(dim, num_controls, num_time, dt, "CoherentCavity_cd_pi_20ns_5g_0.01leakpen_delme");
	...
	Hdrift =  MOs::TensorProduct(HdriftCav, IdentQ) + MOs::TensorProduct(IdentCav, HdriftQ) + (M_PI/tgate/2)*Hcouple;
