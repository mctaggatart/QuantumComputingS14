/*
Name: TestAdapRKCK.cpp
Author: Jay Gambetta

Dependences: OrdinaryDiffEqs.hpp  
Brief Discription: Demonstrates the use of my ODE solver using the RKCK method with an adative stepper
...
{	
	...
	//Files 
	ofstream data_out;
	string filename = "TestAdapRKCK.dat";
