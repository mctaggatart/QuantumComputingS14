/*
Name: TestRombergEuler.cpp
Author: Jay Gambetta

Dependences: OrdinaryDiffEqs.hpp  
Brief Discription: Demonstrates the use of my ODE solver using the Euler method with the Roberg-Richardson extrapolation and a constant stepper
...
{	
	...
	//Files 
	ofstream data_out;
	string filename = "TestRombergEuler.dat";
