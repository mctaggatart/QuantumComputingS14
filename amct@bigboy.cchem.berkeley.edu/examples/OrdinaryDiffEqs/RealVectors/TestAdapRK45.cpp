/*
Name: TestAdapRK45.cpp
Author: Jay Gambetta

Dependences: OrdinaryDiffEqs.hpp  
Brief Discription: Demonstrates the use of my ODE solver using the RK45 method with an adative stepper
...
{	
	...
	//Files 
	ofstream data_out;
	string filename = "TestAdapRK45.dat";
