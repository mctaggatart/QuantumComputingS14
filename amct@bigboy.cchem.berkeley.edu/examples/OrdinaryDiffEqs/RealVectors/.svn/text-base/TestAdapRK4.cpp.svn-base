/*
Name: TestAdapRK4.cpp
Author: Jay Gambetta

Dependences: OrdinaryDiffEqs.hpp  
Brief Discription: Demonstrates the use of my ODE solver using the RK4 method with an adative stepper
...
{	
	...
	//Files 
	ofstream data_out;
	string filename = "TestAdapRK4.dat";
